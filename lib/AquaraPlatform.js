...
AquaraPlatform.prototype.loadConfig = function(config) {
...
AquaraPlatform.prototype.doRestThings = function(api) {
  if (api) {
    // Save the API object as plugin needs to register new accessory via this object.
    this.api = api;

    this.api.on('didFinishLaunching', function() {
        // Send whois to discovery Aquara gateways and resend every 300 seconds
