...
AqaraAccessoryFactory.prototype.registerGatewayCommander = function (platform, gatewayAccessory) {
  ...
  var hueCommander = new commander.LightHueCommander(platform, deviceSid, "gateway", "hue");
  var briCommander = new commander.LightBrightnessCommander(platform, deviceSid, "gateway", "brightness");
