...
AquaraAccessoryFactory.prototype.autoRemoveAccessory = function() {
  var now = Date.now();
  ...
  if (accessoriesToRemove.length > 0) {
    this.api.unregisterPlatformAccessories("homebridge-aquara", "AquaraPlatform", accessoriesToRemove);
  }
}
